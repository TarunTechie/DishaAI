            ...
            <div className="grid justify-center items-center w-screen">
                <div className="grid p-10 justify-center items-center gap-2 bg-[#212121] border-8 w-fit border-orange-800 rounded-xl">
                    ...
                    <div className="grid gap-4 m-6">
                        ...
                        <button className="relative py-2 px-8 text-black text-base font-chalk font-bold rounded-full overflow-hidden bg-white transition-all duration-400 ease-in-out shadow-md hover:scale-105 hover:text-white hover:shadow-lg active:scale-90 before:absolute before:top-0 before:-left-full before:w-full before:h-full before:bg-gradient-to-r before:from-blue-500 before:to-blue-300 before:transition-all before:duration-500 before:ease-in-out before:z-[-1] before:rounded-full hover:before:left-0">
                            LOGIN
                        </button>
                    </div>
                </div>
